...
<form name="settings" id="frmSettings" method="post" action="index.php?Page=<?php print $IEM['CurrentPage']; ?>&<?php if(isset($GLOBALS['FormAction'])) print $GLOBALS['FormAction']; ?>">
	...
	<tr>
		<td>
			<div>
				<br/>
				<ul id="tabnav">
					<li><a href="index.php?Page=Settings&Tab=1" <?php if($tpl->Get('ShowTab') == 1): ?>class="active"<?php endif; ?> id="tab1" onclick="ShowTab(1); return false;"><span><?php echo GetLang('ApplicationSettings_Heading'); ?></span></a></li>
					<li><a href="index.php?Page=Settings&Tab=2" <?php if($tpl->Get('ShowTab') == 2): ?>class="active"<?php endif; ?> id="tab2" onclick="ShowTab(2); return false;"><span><?php echo GetLang('EmailSettings_Heading'); ?></span></a></li>
					<li><a href="index.php?Page=Settings&Tab=7" <?php if($tpl->Get('ShowTab') == 7): ?>class="active"<?php endif; ?> id="tab7" onclick="ShowTab(7); return false;"><span><?php echo GetLang('BounceSettings_Heading'); ?></span></a></li>
					<li><a href="index.php?Page=Settings&Tab=3" <?php if($tpl->Get('ShowTab') == 3): ?>class="active"<?php endif; ?> id="tab3" onclick="ShowTab(3); return false;"><span><?php echo GetLang('CreditSettings_Heading'); ?></span></a></li>
					<li><a href="index.php?Page=Settings&Tab=4" <?php if($tpl->Get('ShowTab') == 4): ?>class="active"<?php endif; ?> id="tab4" onclick="ShowTab(4); return false;"><span><?php echo GetLang('CronSettings_Heading'); ?></span></a></li>
					<li><a href="index.php?Page=Settings&Tab=5" <?php if($tpl->Get('ShowTab') == 5): ?>class="active"<?php endif; ?> id="tab5" onclick="ShowTab(5); return false;"><span><?php echo GetLang('SecuritySettings_Heading'); ?></span></a></li>
					<li><a href="index.php?Page=Settings&Tab=6" <?php if($tpl->Get('ShowTab') == 6): ?>class="active"<?php endif; ?> id="tab6" onclick="ShowTab(6); return false;"><span><?php echo GetLang('AddonsSettings_Heading'); ?></span></a></li>
				</ul>
			...
			$tpl->TemplateData = $tmpTplData; ?>
							...
							<td>
								...
								<input type="text" value="<?php if(isset($GLOBALS['ApplicationURL'])) print $GLOBALS['ApplicationURL']; ?>" class="Field250"> <span class="HelpToolTip"><img src="images/help.gif" alt="?" width="24" height="16" border="0" /><span class="HelpToolTip_Title" style="display:none;"><?php print stripslashes(GetLang('ApplicationURL')); ?></span><span class="HelpToolTip_Contents" style="display:none;"><?php print stripslashes(GetLang('HLP_ApplicationURL')); ?></span></span>
							</td>
						</tr>
						<tr>
							<td class="FieldLabel">
			...
			$tpl->TemplateData = $tmpTplData; ?>
							...
							<td>
								<input type="text" name="licensekey" id="licensekey" value="<?php if(isset($GLOBALS['LicenseKey'])) print $GLOBALS['LicenseKey']; ?>" class="Field250" disabled="disabled"> <span class="HelpToolTip"><img src="images/help.gif" alt="?" width="24" height="16" border="0" /><span class="HelpToolTip_Title" style="display:none;"><?php print stripslashes(GetLang('LicenseKey')); ?></span><span class="HelpToolTip_Contents" style="display:none;"><?php print stripslashes(GetLang('HLP_LicenseKey')); ?></span></span>
							</td>
						</tr>
						<tr>
							<td colspan="2" class="EmptyRow">
