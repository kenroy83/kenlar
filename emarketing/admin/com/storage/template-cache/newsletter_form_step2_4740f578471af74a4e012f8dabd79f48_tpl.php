	...
	<table cellspacing="0" cellpadding="0" width="100%" align="center">
		...
		<tr>
			...
			$tpl->TemplateData = $tmpTplData; ?>
					...
					<tr style="display: <?php if(isset($GLOBALS['DisplayAttachmentsHeading'])) print $GLOBALS['DisplayAttachmentsHeading']; ?>">
					...
					<tr style="display: <?php if(isset($GLOBALS['DisplayAttachments'])) print $GLOBALS['DisplayAttachments']; ?>">
			...
			$tpl->TemplateData = $tmpTplData; ?>
					...
					<tr>
						<td colspan="2" align="left" style="display: <?php if(isset($GLOBALS['DisplayAttachmentsHeading'])) print $GLOBALS['DisplayAttachmentsHeading']; ?>">
