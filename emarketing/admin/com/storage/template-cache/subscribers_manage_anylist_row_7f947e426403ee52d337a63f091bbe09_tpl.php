<?php $IEM = $tpl->Get('IEM'); ?><tr class="GridRow" id="subscriber<?php if(isset($GLOBALS['SubscriberID'])) print $GLOBALS['SubscriberID']; ?>">
	...
	<td>
		<?php if(isset($GLOBALS['MailingListName'])) print $GLOBALS['MailingListName']; ?>
	</td>
	<td>
		<?php if(isset($GLOBALS['SubscriberAction'])) print $GLOBALS['SubscriberAction']; ?>
	</td>
</tr>
<tr class="subscriberEventRow" id="subscriber<?php if(isset($GLOBALS['SubscriberID'])) print $GLOBALS['SubscriberID']; ?>_Events" style="width:100%;">
