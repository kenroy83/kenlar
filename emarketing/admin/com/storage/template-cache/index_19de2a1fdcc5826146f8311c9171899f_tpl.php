...
<div class="Heading1" style="padding-top:5px;"><?php echo GetLang('PageTitle'); ?></div>
		...
		<td valign="top" width="450">
			<div>
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
					<tr>
						<td>
							<table width="446" cellspacing="0" cellpadding="0" class="DashboardPanelBox1" id="GettingStartedPanel">
								<tr>
