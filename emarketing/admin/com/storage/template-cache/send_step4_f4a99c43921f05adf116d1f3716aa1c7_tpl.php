...
<script>
	function PopupWindow() {
		...
		if(confirm('<?php print GetLang('PopupSendWarning'); ?>')) {
			window.open("index.php?Page=Send&Action=Send&Job=<?php if(isset($GLOBALS['JobID'])) print $GLOBALS['JobID']; ?>","sendWin","left=" + left + ",top="+top+",toolbar=false,status=no,directories=false,menubar=false,scrollbars=false,resizable=false,copyhistory=false,width=450,height=290");
		}
	}
</script>
