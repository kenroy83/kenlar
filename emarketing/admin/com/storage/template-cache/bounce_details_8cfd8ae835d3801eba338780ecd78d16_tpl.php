<?php $IEM = $tpl->Get('IEM'); ?>
<?php ob_start(); ?><?php if($tpl->Get('IEM','CurrentPage') == 'lists'): ?>padding-left:20px;<?php endif; ?><?php $tpl->Assign("style", ob_get_contents()); ob_end_clean(); ?>


<?php ob_start(); ?><?php if($tpl->Get('IEM','CurrentPage') == 'bounce'): ?><img src="images/nodejoin.gif" /><?php endif; ?><?php $tpl->Assign("nodejoin", ob_get_contents()); ob_end_clean(); ?>
<?php ob_start(); ?><?php if($tpl->Get('IEM','CurrentPage') == 'bounce'): ?><img width="20" height="20" src="images/blank.gif" /><?php endif; ?><?php $tpl->Assign("blankimg", ob_get_contents()); ob_end_clean(); ?>

<?php if($tpl->Get('IEM','CurrentPage') != 'bounce' && $tpl->Get('IEM','CurrentPage') != 'settings'): ?>
<tr>
		...
		<script>
			Application.Page.BounceInfo = {
					...
					$($('.bounceSettings').fieldSerialize().split('&')).each(function(i, n) {
						...
						if (temp.length == 2) {
							if (temp[0] == 'bounce_password') {
								temp[1] = Application.Util.encrypt(temp[1], key);
							}
				...
				evaluateCheckboxes: function() {
					...
					$(auto_button).click();
					$('#showextramailsettings :checkbox').each(function(i, e) {
				...
				SetupClickEvents: function() {
					...
					f.cmdTestBounce && $(f.cmdTestBounce).click(function() {
						...
						var url = 'index.php?Page=Bounce&Action=PopupBounceTest<?php if($tpl->Get('IEM','CurrentPage') != 'bounce'): ?>&InPlace=true<?php endif; ?>' + Application.Page.BounceInfo.getBounceParameters() + '&keepThis=true&TB_iframe=true&height=240&width=400&modal=true&random=' + new Date().getTime();
						tb_show('', url, '');
						return true;
					});
					<?php if($tpl->Get('IEM','CurrentPage') != 'bounce'): ?>
...
<?php endif; ?>
<?php if(in_array($tpl->Get('IEM','CurrentPage'), array('lists', 'settings'))): ?>
...
<tr style="display: <?php if(isset($GLOBALS['ShowBounceInfo'])) print $GLOBALS['ShowBounceInfo']; ?>">
	<td class="FieldLabel">
		...
		<?php if($tpl->Get('IEM','CurrentPage') == 'settings'): ?><?php print GetLang('SetDefaultBounceAccountDetails'); ?><?php else: ?><?php print GetLang('ProcessBouncesLabel'); ?><?php endif; ?>:&nbsp;
	</td>
	<td>
		<input type="checkbox" name="bounce_process" id="bounce_process" value="1" <?php if(isset($GLOBALS['ProcessBounceChecked'])) print $GLOBALS['ProcessBounceChecked']; ?>/><label for="bounce_process"><?php if($tpl->Get('IEM','CurrentPage') == 'settings'): ?><?php print GetLang('SetDefaultBounceAccountDetailsExplain'); ?><?php else: ?><?php print GetLang('YesProcessBounces'); ?><?php endif; ?></label>
		<?php if($tpl->Get('IEM','CurrentPage') == 'settings'): ?>
...
<tr style="display: <?php if(isset($GLOBALS['ShowBounceInfo'])) print $GLOBALS['ShowBounceInfo']; ?>" class="YesProcessBounce">
	<td class="FieldLabel">
		<?php if($tpl->Get('IEM','CurrentPage') == 'settings'): ?><?php $tmpTplFile = $tpl->GetTemplate();
			$tmpTplData = $tpl->TemplateData;
			$tpl->ParseTemplate("Not_Required");
			$tpl->SetTemplate($tmpTplFile);
		...
		<?php if($tpl->Get('IEM','CurrentPage') == 'settings'): ?><?php print GetLang('DefaultBounceServer'); ?><?php else: ?><?php print GetLang('ListBounceServer'); ?><?php endif; ?>:&nbsp;
	</td>
	<td style="<?php echo $tpl->Get('style'); ?>">
		<?php echo $tpl->Get('nodejoin'); ?> <input type="text" name="bounce_server" id="bounce_server" class="Field250 form_text bounceSettings" value="<?php if(isset($GLOBALS['Bounce_Server'])) print $GLOBALS['Bounce_Server']; ?>">&nbsp;<?php if($tpl->Get('IEM','CurrentPage') == 'settings'): ?><span class="HelpToolTip"><img src="images/help.gif" alt="?" width="24" height="16" border="0" /><span class="HelpToolTip_Title" style="display:none;"><?php print stripslashes(GetLang('DefaultBounceServer')); ?></span><span class="HelpToolTip_Contents" style="display:none;"><?php print stripslashes(GetLang('HLP_DefaultBounceServer')); ?></span></span><?php else: ?><span class="HelpToolTip"><img src="images/help.gif" alt="?" width="24" height="16" border="0" /><span class="HelpToolTip_Title" style="display:none;"><?php print stripslashes(GetLang('ListBounceServer')); ?></span><span class="HelpToolTip_Contents" style="display:none;"><?php print stripslashes(GetLang('HLP_ListBounceServer')); ?></span></span><?php endif; ?>
	</td>
</tr>
<tr style="display: <?php if(isset($GLOBALS['ShowBounceInfo'])) print $GLOBALS['ShowBounceInfo']; ?>" class="YesProcessBounce">
	<td class="FieldLabel">
		<?php if($tpl->Get('IEM','CurrentPage') == 'settings'): ?><?php $tmpTplFile = $tpl->GetTemplate();
			...
			$tpl->SetTemplate($tmpTplFile);
			$tpl->TemplateData = $tmpTplData; ?><?php endif; ?>
		<?php if($tpl->Get('IEM','CurrentPage') == 'settings'): ?><?php print GetLang('DefaultBounceUsername'); ?><?php else: ?><?php print GetLang('ListBounceUsername'); ?><?php endif; ?>:&nbsp;
	</td>
	<td style="<?php echo $tpl->Get('style'); ?>">
		<?php echo $tpl->Get('blankimg'); ?> <input type="text" name="bounce_username" class="Field250 form_text bounceSettings" value="<?php if(isset($GLOBALS['Bounce_Username'])) print $GLOBALS['Bounce_Username']; ?>">&nbsp;<?php if($tpl->Get('IEM','CurrentPage') == 'settings'): ?><span class="HelpToolTip"><img src="images/help.gif" alt="?" width="24" height="16" border="0" /><span class="HelpToolTip_Title" style="display:none;"><?php print stripslashes(GetLang('DefaultBounceUsername')); ?></span><span class="HelpToolTip_Contents" style="display:none;"><?php print stripslashes(GetLang('HLP_DefaultBounceUsername')); ?></span></span><?php else: ?><span class="HelpToolTip"><img src="images/help.gif" alt="?" width="24" height="16" border="0" /><span class="HelpToolTip_Title" style="display:none;"><?php print stripslashes(GetLang('ListBounceUsername')); ?></span><span class="HelpToolTip_Contents" style="display:none;"><?php print stripslashes(GetLang('HLP_ListBounceUsername')); ?></span></span><?php endif; ?>
	</td>
</tr>
<tr style="display: <?php if(isset($GLOBALS['ShowBounceInfo'])) print $GLOBALS['ShowBounceInfo']; ?>" class="YesProcessBounce">
	<td class="FieldLabel">
		<?php if($tpl->Get('IEM','CurrentPage') == 'settings'): ?><?php $tmpTplFile = $tpl->GetTemplate();
			...
			$tpl->SetTemplate($tmpTplFile);
			$tpl->TemplateData = $tmpTplData; ?><?php endif; ?>
		<?php if($tpl->Get('IEM','CurrentPage') == 'settings'): ?><?php print GetLang('DefaultBouncePassword'); ?><?php else: ?><?php print GetLang('ListBouncePassword'); ?><?php endif; ?>:&nbsp;
	</td>
	<td style="<?php echo $tpl->Get('style'); ?>">
		<?php echo $tpl->Get('blankimg'); ?> <input type="password" name="bounce_password" class="Field250 form_password bounceSettings" value="<?php if(isset($GLOBALS['Bounce_Password'])) print $GLOBALS['Bounce_Password']; ?>" autocomplete="off" />&nbsp;<?php if($tpl->Get('IEM','CurrentPage') == 'settings'): ?><span class="HelpToolTip"><img src="images/help.gif" alt="?" width="24" height="16" border="0" /><span class="HelpToolTip_Title" style="display:none;"><?php print stripslashes(GetLang('DefaultBouncePassword')); ?></span><span class="HelpToolTip_Contents" style="display:none;"><?php print stripslashes(GetLang('HLP_DefaultBouncePassword')); ?></span></span><?php else: ?><span class="HelpToolTip"><img src="images/help.gif" alt="?" width="24" height="16" border="0" /><span class="HelpToolTip_Title" style="display:none;"><?php print stripslashes(GetLang('ListBouncePassword')); ?></span><span class="HelpToolTip_Contents" style="display:none;"><?php print stripslashes(GetLang('HLP_ListBouncePassword')); ?></span></span><?php endif; ?>
	</td>
</tr>
<tr style="display: <?php if(isset($GLOBALS['ShowBounceInfo'])) print $GLOBALS['ShowBounceInfo']; ?>" class="YesProcessBounce">
	<td class="FieldLabel">
...
<tr class="YesProcessBounce" style="display: <?php if(isset($GLOBALS['ShowBounceInfo'])) print $GLOBALS['ShowBounceInfo']; ?>">
	<td class="FieldLabel">
		<?php $tmpTplFile = $tpl->GetTemplate();
			...
			$tpl->SetTemplate($tmpTplFile);
			$tpl->TemplateData = $tmpTplData; ?>
		<?php if($tpl->Get('IEM','CurrentPage') == 'settings'): ?><?php print GetLang('TestBounceSettings'); ?>:<?php endif; ?>&nbsp;
	</td>
