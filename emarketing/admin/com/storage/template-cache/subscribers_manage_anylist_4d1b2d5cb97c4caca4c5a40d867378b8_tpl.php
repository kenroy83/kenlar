...
<table cellspacing="0" cellpadding="0" width="100%" align="center">
	...
	<tr>
		<td class="body" valign="bottom">
			<form name="ActionMembersForm" method="post" action="index.php?Page=Subscribers&Action=Manage&SubAction=Change&Lists[]=<?php if(isset($GLOBALS['List'])) print $GLOBALS['List']; ?>" onsubmit="return ConfirmChanges();">
						...
						<td valign="bottom">
							<div>
								<select name="ChangeType">
									...
									<option value="Delete"><?php print GetLang('Delete'); ?></option>
				...
				<table border=0 cellspacing="0" cellpadding="0" width=100% class="Text">
					<tr class="Heading3">
						...
						<td>
							<?php print GetLang('MailingList'); ?>&nbsp;<a href='index.php?Page=Subscribers&Action=Manage&SubAction=Step3&SortBy=ListName&Direction=Up&'><img src="images/sortup.gif" border=0></a>&nbsp;<a href='index.php?Page=Subscribers&Action=Manage&SubAction=Step3&SortBy=ListName&Direction=Down'><img src="images/sortdown.gif" border=0></a>
						</td>
						<td size="75" nowrap>
