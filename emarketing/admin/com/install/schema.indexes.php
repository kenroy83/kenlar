...
$queries[] = "CREATE INDEX %%TABLEPREFIX%%user_access_userid_idx on %%TABLEPREFIX%%user_access(userid)";
$queries[] = "CREATE UNIQUE INDEX %%TABLEPREFIX%%user_access_userid_area_id_idx on %%TABLEPREFIX%%user_access(userid, area, id)";
...
if (SENDSTUDIO_DATABASE_TYPE == 'mysql') {
	$queries[] = "CREATE UNIQUE INDEX %%TABLEPREFIX%%user_permissions_userid_area_subarea_idx on %%TABLEPREFIX%%user_permissions(userid, area (94), subarea (94))";
} else {
	$queries[] = "CREATE UNIQUE INDEX %%TABLEPREFIX%%user_permissions_userid_area_subarea_idx on %%TABLEPREFIX%%user_permissions(userid, area, subarea)";
}
