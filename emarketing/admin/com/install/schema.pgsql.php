...
$queries[] = "INSERT INTO %%TABLEPREFIX%%users(username, password, status, admintype, listadmintype, templateadmintype, createdate, lastloggedin, unlimitedmaxemails, infotips, usewysiwyg, gettingstarted) values('admin', md5('password'), '1', 'a', 'a', 'a', " . $time . ", '0', '1', '1', '1', '0')";
