			...
			<td>
				<div>
					...
					<ul id="tabnav">
						...
						<li><a href="#" id="tab5" onclick="ShowTab(5); return false;"><span>%%LNG_GoogleSettings_Heading%%</span></a></li>
					</ul>
					...
					<div id="div2" style="display:none; padding-top:10px">
						<table border="0" cellspacing="0" cellpadding="2" width="100%" class="Panel">
							...
							<tr>
								<td class="FieldLabel">
									{template="Not_Required"}
									%%LNG_ForceDoubleOptIn%%:
								</td>
								<td>
									<div>
										<label for="forcedoubleoptin">
											<input type="checkbox" name="forcedoubleoptin" id="forcedoubleoptin" value="1" %%GLOBAL_ForceDoubleOptInChecked%%/>
											{$lang.ForceDoubleOptIn_Explain}
										</label>
										{$lnghlp.ForceDoubleOptIn}
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div>
										<label for="forcespamcheck">
											<input type="checkbox" name="forcespamcheck" id="forcespamcheck" value="1" %%GLOBAL_ForceSpamCheckChecked%%/>
											{$lang.ForceSpamCheck_Explain}
										</label>
										{$lnghlp.ForceSpamCheck}
									</div>
								</td>
							</tr>
						</table>
