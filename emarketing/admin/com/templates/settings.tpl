	...
	<tr>
		<td>
			<div>
				<br/>
				<ul id="tabnav">
					<li><a href="index.php?Page=Settings&Tab=1" {if $ShowTab == 1}class="active"{/if} id="tab1" onclick="ShowTab(1); return false;"><span>{$lang.ApplicationSettings_Heading}</span></a></li>
					<li><a href="index.php?Page=Settings&Tab=2" {if $ShowTab == 2}class="active"{/if} id="tab2" onclick="ShowTab(2); return false;"><span>{$lang.EmailSettings_Heading}</span></a></li>
					<li><a href="index.php?Page=Settings&Tab=7" {if $ShowTab == 7}class="active"{/if} id="tab7" onclick="ShowTab(7); return false;"><span>{$lang.BounceSettings_Heading}</span></a></li>
					<li><a href="index.php?Page=Settings&Tab=3" {if $ShowTab == 3}class="active"{/if} id="tab3" onclick="ShowTab(3); return false;"><span>{$lang.CreditSettings_Heading}</span></a></li>
					<li><a href="index.php?Page=Settings&Tab=4" {if $ShowTab == 4}class="active"{/if} id="tab4" onclick="ShowTab(4); return false;"><span>{$lang.CronSettings_Heading}</span></a></li>
					<li><a href="index.php?Page=Settings&Tab=5" {if $ShowTab == 5}class="active"{/if} id="tab5" onclick="ShowTab(5); return false;"><span>{$lang.SecuritySettings_Heading}</span></a></li>
					<li><a href="index.php?Page=Settings&Tab=6" {if $ShowTab == 6}class="active"{/if} id="tab6" onclick="ShowTab(6); return false;"><span>{$lang.AddonsSettings_Heading}</span></a></li>
				</ul>
					...
					<table border="0" cellspacing="0" cellpadding="2" width="100%" class="Panel">
						...
						<tr>
							...
							<td>
								...
								<input type="text" value="%%GLOBAL_ApplicationURL%%" class="Field250"> %%LNG_HLP_ApplicationURL%%
							</td>
						</tr>
						<tr>
							<td class="FieldLabel">
						...
						<tr>
							...
							<td>
								<input type="text" name="licensekey" id="licensekey" value="%%GLOBAL_LicenseKey%%" class="Field250" disabled="disabled"> %%LNG_HLP_LicenseKey%%
							</td>
						</tr>
						<tr>
							<td colspan="2" class="EmptyRow">
