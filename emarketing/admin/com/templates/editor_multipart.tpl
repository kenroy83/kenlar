		...
		<td colspan="2">
			<table id="tabContents_HTMLEditor" width="100%">
				...
				<tr id="htmlCF">
					...
					<td>
						<input type="button" onclick="javascript: ShowCustomFields('html', 'myDevEditControl', '%%PAGE%%'); return false;" value="%%LNG_ShowCustomFields%%..." class="FormButton" style="width: 150px;" />
			...
			<table id="tabContents_TextEditor" width="100%">
				...
				<tr id="textCF">
					...
					<td>
						...
						<input class="FormButton" type="button" name="" value="%%LNG_GetTextContent%%" style="width:170px" onClick="grabTextContent('TextContent','myDevEditControl');"/>
					</td>
				</tr>
			</table>
		</td>
