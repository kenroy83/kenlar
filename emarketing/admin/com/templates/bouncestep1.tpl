										...
										<div class="ISSelect" style="width:300px;">
											<ul>
												...
												{foreach from=$bounce_server_map key=key item=server}
													<li onclick="$('#server_{$server.0.id}').click();" onmouseover="$(this).addClass('ISSelectOptionHover');" onmouseout="$(this).removeClass('ISSelectOptionHover');" style="cursor:pointer;">
