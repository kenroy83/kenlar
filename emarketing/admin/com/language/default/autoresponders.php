...
define('LNG_EditAutoresponderIntro', 'Complete the form below to update the selected autoresponder. You can also <a href="#" onClick="LaunchHelp(\'797\'); return false;">learn more about autoresponders</a>.');
...
define('LNG_Autoresponder_Step1_Intro', 'Autoresponders are emails that you can set up to be sent automatically to contacts at different intervals after they subscribe. <a href="#" onClick="LaunchHelp(\'797\'); return false;">Learn more about autoresponders</a>.');

define('LNG_Help_AutorespondersManage', LNG_Autoresponder_Step1_Intro);

define('LNG_CreateAutoresponder_Step1_Intro', 'Creating an autoresponder is a multi-step process. Start by entering a name and choosing who should receive it and then click the <em>Next &gt;&gt;</em> button.  <a href="#" onClick="LaunchHelp(\'797\'); return false;">Get help on autoresponders here</a>.');
...
define('LNG_AutoresponderCronNotEnabled', 'Before your contacts can receive autoresponders, you need to setup scheduled sending. Please see <a href="#" onclick="LaunchHelp(\'841\'); return false;">this article</a> to learn how, or contact your administrator.');

define('LNG_Autoresponder_Name_Reference', 'This name is for your reference only and isn\'t shown to anyone');
define('LNG_Autoresponder_Filter_Help', 'Fill in the fields below to filter contacts. You don\'t have to fill in all fields, only the ones you want to filter on. <a onclick="LaunchHelp(\'832\'); return false;" href="#">Learn more about filtering contacts.</a>');
