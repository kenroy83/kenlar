...
* @see GetLang
*
* @author Hendri <hendri@sCRiPTz-TEAM.iNFO>
*
* @package SendStudio
* @subpackage Language
*/
...
define('LNG_TriggerEmails_Manage_CRON_Alert', 'You need to setup scheduled sending to enable triggers. Please see <a href="#" onclick="LaunchHelp(\'841\'); return false;">this article</a> to learn how, or contact your administrator.');

define('LNG_TriggerEmails_Manage_AddListButton', 'Create new contact list ...');
define('LNG_TriggerEmails_Manage_NoLists', 'No "Contact List" has been defined. %s');
...
define('LNG_TriggerEmails_Manage_AddCampaignButton', 'Create new campaign ...');
define('LNG_TriggerEmails_Manage_NoCampaigns', 'No Email Campaign has been defined. %s');
