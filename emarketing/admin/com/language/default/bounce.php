...
define('LNG_ExplainBounceDeleteAll', 'Warning: This option is dangerous to use if multiple lists use the same bounce account. <a href="#" onClick="LaunchHelp(\'845\'); return false;">Why?</a>');
