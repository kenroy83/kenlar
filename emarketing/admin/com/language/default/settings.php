...
define('LNG_CronEnabledExplain', 'Yes, I want to enable cron support (<a onclick="LaunchHelp(819); return false;" href="#">How can I enable cron?</a>)');
...
**************************
*/
define('LNG_CronRunTime_Explain', 'When you add the cron command (above) to your crontab, it needs to run at least as frequently as the <em>Run Every</em> times you choose below. <a onclick="LaunchHelp(842); return false;" href="#">Learn why</a>.');
