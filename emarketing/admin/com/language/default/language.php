...
define('LNG_Menu_Users_Description', 'User account allow other users to login and use the system to a level you allow.');
...
define('LNG_SettingsShowSMTPCOM', 'Show SMTP.com option');
define('LNG_SettingsShowSMTPCOMLabel', 'Show SMTP.com option');
...
define('LNG_Subscribers_Search_Step2', 'Search for contacts by entering search keywords and changing options in the form below. Learn how to search contacts more efficiently by reading <a href="#" onClick="LaunchHelp(\'832\'); return false;">this article</a>.');
...
define('LNG_TextWidthLimit_Explaination', 'If possible, keep your text to the left of the gray line above. <a href="#" onclick="LaunchHelp(839); return false;" style="color:#999999;">Why</a>?');
...
define('LNG_GuideToFiltering', '<a href="#" onClick="LaunchHelp(\'832\'); return false;">Learn more about filtering contacts.</a>');
