...
define('LNG_Help_FormsManage', 'Website forms can be placed on your website to collect new contacts, let existing contacts modify their details, or even unsubscribe from your list. <a href="javascript:LaunchHelp(809);">Learn more here.</a>');
...
define('LNG_WhatAreTheForms', '<a href="javascript:LaunchHelp(809);">What are the different types of Website Forms and how do I use them.</a>');
...
define('LNG_FormCustomFieldSelection', 'Choose the list(s) you want to add/remove contact from and which custom fields to include on your form. <a href="#" onClick="LaunchHelp(840); return false;">Learn more here</a>.');
