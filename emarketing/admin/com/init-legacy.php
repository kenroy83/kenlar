...
if (SENDSTUDIO_IS_SETUP) {
	require(SENDSTUDIO_BASE_DIRECTORY . '/addons/interspire_addons.php');
...
if (SENDSTUDIO_IS_SETUP) {
	require(IEM_PATH . '/ext/interspire_log/interspire_log.php');
...
*/
define('SENDSTUDIO_DATABASE_VERSION', '20090420');
