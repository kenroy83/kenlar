...
class IEM_Installer
{
	...
	public function SaveDefaultSettings()
	{
		...
		$unique_token = API_USERS::generateUniqueToken('admin');
		$password = API_USERS::generatePasswordHash($_POST['admin_password'], $unique_token);
		...
		$query .= " unique_token='" . $this->_db->Quote($unique_token) . "', ";
	...
	public function RegisterAddons()
	{
		...
		$addons_to_install = array('checkpermissions', 'dbcheck', 'emaileventlog', 'splittest', 'systemlog', 'updatecheck');
