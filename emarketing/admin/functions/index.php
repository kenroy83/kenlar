...
class Index extends SendStudio_Functions
{
	...
	function Process()
	{
		 ...
		 */
		$ajax_actions = array('switch', 'subscribergraph', 'cleanupexport', 'hidethis', 'getcampaignlist', 'campaignview', 'getcampaigndropdown', 'getcampaignchart', 'getrecentlists');
	...
	function PrintNewsletterStatsChart($statid=0)
	{
		...
		$chart = InsertChart('pie', $data_url, array('graph_title' => GetLang("NewsletterSummaryChart"), 'y_position' => '150', 'x_position' => '200', 'legend_x_position' => '0', 'legend_y_position' => '215', 'title_align' => 'left'));
