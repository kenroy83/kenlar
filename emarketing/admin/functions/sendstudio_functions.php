...
class SendStudio_Functions
{
	...
	*/
	static function GenerateTextMenuLinks()
	{
		...
		$lke = IEM::sessionGet('LicenseError', true);
			...
			*/
			...
			if ($approve_job) {
				...
				if ($send_size) {
					...
					IEM::sessionSet('__CurrentUser_ID', $user->userid);
