...
class Jobs_Cron_API_Splittest extends Splittest_Send_API
{
	...
	private function _ProcessJob($jobid=0)
	{
		...
		// ----- TODO think of a better way... The session variable "__CurrentUser_ID" or "__CurrentUser_Object" should only be modified in one place
			$user = GetUser($jobinfo['ownerid']);
			IEM::sessionSet('__CurrentUser_ID', $jobinfo['ownerid']);
