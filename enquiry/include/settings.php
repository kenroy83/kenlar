...
define('SECRET_SALT','1E308B8436920A0');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','computers@kenlar.net');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','kenlar.net.mysql'); 
define('DBNAME','kenlar_net');
define('DBUSER','kenlar_net');
define('DBPASS','2yDXjaGd');
